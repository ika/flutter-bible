...
class WordsPageState extends State<WordsPage> {
  ...
  //
  //   try {
  //     // final candidates = await isar.words
  //     //     .filter()
  //     //     .latContains(query, caseSensitive: false)
  //     //     .findAll();
  //
  //     final results = await isar.words
  //         .filter()
  //         .latContains(isarQuery, caseSensitive: false)
  //         .findAll();
  //
  //     // Match whole words only (escape the query and use word boundaries)
  //     // final pattern = RegExp(r'\b' + RegExp.escape(query) + r'\b',
  //     //     caseSensitive: false, unicode: true);
  //
  //     // final results = candidates.where((w) => pattern.hasMatch(w.lat)).toList();
  //
  //     setState(() {
  //       _results = results;
  //       _searching = false;
